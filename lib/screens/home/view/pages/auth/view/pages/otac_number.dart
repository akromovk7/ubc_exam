        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child:
                  Text("Enter Authorization Code", style: FontStyles.welcome),
            ),
            Padding(
              padding: EdgeInsets.only(top: 16.h),
              child:
                  Text("We have sent SMS to:", style: FontStyles.greytextmini),
            ),
            ...
            Container(
              ...
              height: 52.h,
              width: 374.w,
              margin: EdgeInsets.only(left: 20.w, top: 40.h,right: 20.w,bottom: 10),
            ...
            Padding(
                  ...
                  child: MyElevatedButton.buttonstyle(
                      ontap: () =>
                          context.read<AuthCubit>().changeState(ResetPasswordState()),
                      text: "Sign in"),
                ),
          ],
        ),
